...
export const getLocalStorageLanguage = () => localStorageManager.getItem<LangCode, true>(STORAGE_KEYS.I_18_N, true);

export const removeLocalStorageLanguage = () => localStorageManager.removeItem(STORAGE_KEYS.I_18_N);

export const setLocalStorageLanguage = (value: LangCode) => localStorageManager.setItem(STORAGE_KEYS.I_18_N, value);
